...
"""
#q1: for each num in list_b, get the num and its index in mylist. return the res as a list of tuples.
...
"""
sentences=["a new world record was set", "in the holy city of ayodhya", "in the eve of diwali on tuesday", "with over three lakh diya or earthen lamps", "lit up simultaneously on the banks of the sarayu river"]
